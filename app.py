...
features = joblib.load('car_column.pkl')
st.write(features)
...
if st.button("Predict"):
    ...
    # Make prediction 
    # (improvised in this portion if X_train.columns was dumped the following two lines are not to be used instead used
